...
- **Deployment & Testing**: Containerized with Docker and `docker-compose.yml`, deployed live at `netgrade.certifa.net`, and backed by a Pytest suite of **443 passing unit and integration tests**.
...
- **Green Suite Across Every Layer**: Built a test suite of **443 passing tests** (`pytest -v`) covering edge cases, scoring math, check isolation, and custom 404/500 exception handlers.
