...
- **Deployment & Testing**: Containerized with Docker and `docker-compose.yml`, deployed live at `netgrade.certifa.net`, and backed by a Pytest suite of **414 passing unit and integration tests**.
...
- **100% Test Coverage & Green Suite**: Built a comprehensive test suite with **414 passing tests** (`pytest -v`) covering edge cases, scoring math, check isolation, and custom 404/500 exception handlers.
